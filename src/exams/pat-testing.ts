...
function makeOfficialPatVariant(sectionIndex: number): ExamQuestion[] {
  const chunkSize = 7;
  return exactAccessTrainingPatQuestions
...
export const patTestingExam: Exam = {
  ...
  format:
    "Each attempt = 35 multiple-choice questions across all sections. Pass at 70%+. The bank rotates through 4 broad revision variants plus 1 official Access Training homework variant.",
  passPercent: 0.7,
  sections: [
    {
      id: "section-1",
      ...
      variants: [
        ...
        {
          id: "v5",
          questions: makeOfficialPatVariant(0)
        }
      ]
    },
    {
      ...
      variants: [
        ...
        {
          id: "v5",
          questions: makeOfficialPatVariant(1)
        }
      ]
    },
    {
      ...
      variants: [
        ...
        {
          id: "v5",
          questions: makeOfficialPatVariant(2)
        }
      ]
    },
    {
      ...
      variants: [
        ...
        {
          id: "v5",
          questions: makeOfficialPatVariant(3)
        }
      ]
    },
    {
      ...
      variants: [
        ...
        {
          id: "v5",
          questions: makeOfficialPatVariant(4)
        }
      ]
    }
  ],
  ...
  priorities: [
    ...
    "Official homework corrections: 0.75 mm2, 2 m rewireable flex = 10 A; toaster = mobile; combined inspection/test record wording = Form 4.1."
  ]
};

...
export const EXAMS: Exam[] = [
        ...
        questions: [
          {
            ...
            answer: "B",
            explanation: "Part P applies to fixed electrical installations in dwellings, including outbuildings (sheds, garages), garden lighting, and the shared/common parts of buildings that contain dwellings. Commercial-only work falls under EAWR and BS 7671 but not Part P."
          },
          {
            number: 2,
            prompt: "Since the April 2013 changes, notifiable work under Part P in England is limited to:",
            options: {
            ...
            answer: "C",
            explanation: "Three categories remain notifiable in England: a new circuit, a consumer unit replacement (or main switch replacement), and any addition/alteration in a special location. Kitchens and outdoor work were removed from the notifiable list in 2013, though the work still has to comply."
          },
          {
            number: 3,
            prompt: "For Part P purposes, a \"special location\" in a dwelling is most commonly a:",
            options: {
            ...
            answer: "C",
            explanation: "The Part P definition of a special location post-2013 is essentially \"a room containing a bath or shower\" within zones 0, 1 or 2 as defined by BS 7671 Section 701. Swimming pools and saunas are also special locations under BS 7671 but are far less common in domestic work."
          },
          {
            number: 4,
            prompt: "Carrying out notifiable Part P work without using one of the approved compliance routes is:",
            options: {
            ...
            answer: "B",
            explanation: "Failing to notify is an offence under the Building Act 1984, prosecutable for up to 2 years after completion. The local authority can serve an enforcement notice requiring the work to be altered or removed; in practice the bigger problem for most owners is that they cannot prove compliance when they sell."
          }
        ]
      },
      {
        ...
        questions: [
          {
            ...
            answer: "B",
            explanation: "AD B is fire safety — relevant whenever you penetrate a fire-rated wall or floor, or install cables in escape routes (where Reg 521.11.201 of BS 7671 also requires non-combustible cable supports)."
          },
          {
            number: 6,
            ...
            answer: "B",
            explanation: "AD L drives the energy-efficiency requirements you meet through low-energy lighting, heating-control wiring, EV-charge-ready provision in new dwellings, and similar. AD M is access; AD E is sound; AD H is drainage."
          },
          {
            number: 7,
            ...
            answer: "A",
            explanation: "AD A is structure — relevant to electricians when you notch or drill joists (the safe-zone rules in AD A are echoed in BS 7671's safe-zone wiring rules in Reg 522.6.202)."
          },
          {
            number: 8,
            ...
            answer: "B",
            explanation: "AD F is ventilation — relevant when you wire extract fans (kitchen, bathroom, MVHR) and need to know minimum extract rates and whether intermittent or continuous-running fans are required."
          }
        ]
      },
      {
        ...
        questions: [
          {
            number: 9,
            prompt: "The three routes to compliance for notifiable Part P work in England are:",
            options: {
            ...
            answer: "A",
            explanation: "The three legitimate routes are: (1) being a CPS member and self-certifying via your scheme, (2) notifying the local authority before starting work and having it inspected, or (3) using a registered third-party certifier to inspect after completion. Only the CPS route is realistic for most production work."
          },
          {
            number: 10,
            prompt: "Examples of recognised Competent Person Schemes for electrical work in England include:",
            options: {
              A: "HSE and DNO",
            ...
            answer: "B",
            explanation: "CPSs are private bodies authorised by DLUHC (now MHCLG) to self-certify Part P work — the principal ones are NICEIC, NAPIT, Stroma and ELECSA. The IET writes the Wiring Regulations but is not itself a CPS; the JIB / ECA are trade bodies, not certifiers."
          },
          {
            number: 11,
            prompt: "The legal status of BS 7671 (the IET Wiring Regulations) in England is:",
            options: {
            ...
            answer: "B",
            explanation: "BS 7671 itself is not law, but compliance with it is one of the recognised ways of demonstrating that the safety objectives of Part P (and the design and construction provisions of EAWR 1989) have been met. A court can accept other approaches, but in practice every prosecution is measured against BS 7671."
          },
          {
            number: 12,
            prompt: "After completing notifiable Part P work as a CPS member, the contractor must:",
            options: {
        ...
        questions: [
          {
            ...
            answer: "C",
            explanation: "BS 5839-6: ceiling-mounted heat detectors must have the sensing element 25–150 mm below the ceiling so it sits in the rising layer of hot gases. Placing it directly under an AC outlet would cool the sensor; 500 mm below would put it below the heat layer."
          },
          {
            number: 14,
            ...
            answer: "C",
            explanation: "Part E targets airborne sound transmission. Back-to-back accessory boxes punch a near-direct sound path through a separating wall, so Part E requires sockets to be staggered horizontally on opposite faces. Deep boxes and chases would worsen the problem, not help it."
          },
          {
            number: 15,
            ...
            answer: "C",
            explanation: "CPS members self-certify after the work, so prior notice is not needed. A non-CPS enterprise carrying out notifiable work must give the local authority Building Control prior notice (Building Notice or Full Plans) before starting. Non-notifiable work needs no notification at all."
          },
          {
            number: 16,
            prompt: "An EV charging point can be connected to a PME supply, as long as one of the four provisions of Regulation: 722.411.4.1 are met, or, what else?",
            options: {
            ...
            answer: "C",
            explanation: "Reg 722.411.4.1 lists the open-PEN protection options for EV charge-points on PME. The alternative route is to provide isolation from the PME earthing arrangement — typically with a separating/isolating transformer or a dedicated TT earth electrode, so any open-PEN fault cannot be exported to the vehicle."
          },
          {
            number: 17,
            ...
            answer: "B",
            explanation: "Part L1A/L1B (Conservation of Fuel and Power) covers fixed building services like heating, hot water, ventilation and lighting. Solar PV electrical installation is covered by BS 7671 Section 712 and the MCS standards rather than Part L itself — Part L only counts PV as a contribution to the dwelling's energy efficiency calculation."
          },
          {
            number: 18,
            prompt: "The statement is a requirement of which Approved Document? The building shall be designed and constructed so that there are appropriate provisions for the early warning of fire?",
            options: {
            ...
            answer: "C",
            explanation: "Part B is fire safety. B1 specifically requires means of warning and escape — the statutory requirement underpinning smoke-alarm provision in dwellings (Volume 1) and fire alarm systems in non-dwellings (Volume 2). Part A is structure, M is access, F is ventilation."
          },
          {
            number: 19,
            ...
            answer: "B",
            explanation: "Reg 7 covers materials and workmanship: workmanlike manner, adequate and proper materials, materials applied properly. Competent Person Schemes are about Part P notification, not Reg 7 — there is no requirement that all building work be done by registered persons."
          },
          {
            number: 20,
            ...
            answer: "C",
            explanation: "Part F Table 5.1a — intermittent extract: 30 L/s if the fan is over the hob (cooker hood), 60 L/s elsewhere in the kitchen. A fan adjacent to (not over) the hob falls in the 60 L/s category."
          },
          {
            number: 21,
            ...
            answer: "B",
            explanation: "Part B — Fire safety. B1 is the means of warning and escape requirement. F is ventilation, E is sound, L is energy efficiency."
          },
          {
            number: 22,
          ...
          },
          {
            ...
            answer: "D",
            explanation: "Part P applies to dwellings, associated outbuildings/gardens, common access areas in blocks of flats, shared amenities, and business premises sharing a supply with a dwelling. It does not apply to business premises in the same building where they have separate metering."
          },
          {
            number: 24,
            prompt: "In order to comply with the requirements of Approved Document Part C, persons carrying out electrical work in new buildings should",
            options: {
            ...
            answer: "C",
            explanation: "Part C is site preparation and resistance to contaminants and moisture. The electrical implication is that any cable penetration through the external envelope (or a ground-floor slab) must be sealed against gas (radon, methane) and water ingress. Energy efficiency is L, ventilation is F, switch heights are M."
          },
          {
            number: 25,
            ...
            answer: "B",
            explanation: "A new outdoor lighting circuit is a new circuit — notifiable. CE-marked prefabricated systems with plug-and-socket connectors are treated as accessories rather than a new circuit. Maintenance is non-notifiable. Work confined to an existing shed circuit is non-notifiable."
          },
          {
            number: 26,
            ...
            answer: "D",
            explanation: "Approved Document A: notches in joists must not exceed 0.125 × the joist depth, and only in the top edge between 0.07 and 0.25 of the span from the support. Drilled holes have separate limits (max 0.25 × depth on the neutral axis)."
          },
          {
            number: 27,
            prompt: "Electrical testing should be carried out in the correct sequence. Which of the following is classed as the first live test?",
            options: {
            ...
            answer: "B",
            explanation: "Continuity, IR and ring continuity are all dead tests. The live test sequence per BS 7671 / GN3 starts with confirming polarity at the origin, then earth electrode resistance (TT), then earth fault loop impedance Ze/Zs, PFC, phase rotation, RCDs, functional."
          },
          {
            number: 28,
            ...
            answer: "C",
            explanation: "Approved Document A and BS EN 1996-2: vertical chases must not exceed 1/3 of the wall thickness; horizontal chases must not exceed 1/6. Deeper chases compromise the structural strength of the masonry."
          },
          {
            number: 29,
            ...
            answer: "D",
            explanation: "BS 6891 / IGE/G/1: minimum 150 mm horizontal separation between gas pipework and electricity meters, consumer units or other electrical equipment. Where they cross, 25 mm separation with insulation is acceptable but 150 mm is the headline figure most often examined."
          },
          {
            number: 30,
            prompt: "A way of satisfying the requirements of approved document M is to install switches at a height",
            options: {
            ...
            answer: "D",
            explanation: "Part M Volume 1 (dwellings): switches, sockets and other accessories that need regular operation must be 450 mm to 1200 mm from the finished floor level so they are reachable from a wheelchair. This is for new dwellings; existing dwellings have no retrospective duty."
          },
          {
            number: 31,
            prompt: "Which of these cable installation methods has the highest maximum current carrying capacity (Iz)?",
            options: {
              A: "100",
              B: "A",
              C: "103",
            ...
            answer: "D",
            explanation: "BS 7671 Reference Method C — clipped direct on a wall or ceiling — gives the highest Iz of the listed methods because the cable can dissipate heat freely. Methods A (in conduit in an insulated wall) and 100/103 (in masonry / fully in insulation) all derate the cable."
          },
          {
            number: 32,
            prompt: "What is the minimum conductor cross sectional area for a radial circuit in a household protected by a 32A overcurrent device?",
            options: {
              A: "1.5mm Squared",
              B: "0.75mm Squared",
              C: "4.0mm Squared",
            ...
            answer: "C",
            explanation: "OSG Table 7.1 — a 32 A radial socket-outlet circuit needs 4 mm² live conductors (typically with 1.5 mm² CPC in T+E) on the standard reference methods. 2.5 mm² T+E only carries up to 27 A in many install methods, so it cannot be protected by a 32 A device."
          },
          {
            number: 33,
            prompt: "A contractor adds an extra socket to an existing ring final circuit in a living room, outside any special location. Under Part P in England this work is:",
            options: {
            ...
            answer: "C",
            explanation: "An addition to an existing circuit outside a special location is non-notifiable. That does not make it unregulated: the work is still within Part P, must be safe, and should be recorded on a Minor Electrical Installation Works Certificate."
          },
          {
            number: 34,
            prompt: "Replacing a domestic consumer unit in England is:",
            options: {
            ...
            answer: "B",
            explanation: "The three notifiable categories include replacement of a consumer unit. It remains notifiable even if the outgoing circuits are unchanged, because the consumer unit is central to fault protection, RCD provision, main isolation and circuit identification."
          },
          {
            number: 35,
            prompt: "A shop sits below a flat in the same building. The shop has its own separate electricity meter and supply. Part P applies to the shop's electrical installation:",
            options: {
            ...
            answer: "D",
            explanation: "Part P includes business premises only where they are connected to the same meter or source as the dwelling. A separately metered shop is outside Part P, although BS 7671 and workplace legislation still apply."
          },
          {
            number: 36,
            prompt: "In a new dwelling, one way of satisfying Approved Document M for ordinary light switches and socket-outlets is to install them:",
            options: {
            ...
            answer: "B",
            explanation: "Part M guidance for new dwellings puts frequently used switches and sockets between 450 mm and 1200 mm above finished floor level. Consumer unit switch heights are a separate Part M detail and should not be confused with accessory heights."
          },
          {
            number: 37,
            prompt: "A horizontal chase in a masonry wall should generally not exceed:",
            options: {
            ...
            answer: "A",
            explanation: "Horizontal chases are limited to 1/6 of wall thickness; vertical chases are limited to 1/3. The trap is swapping those two figures. Chasing beyond the limits weakens the wall and can crack finishes or structure."
          },
          {
            number: 38,
            prompt: "Holes drilled through timber joists for cables should generally be located:",
            options: {
            ...
            answer: "B",
            explanation: "Approved Document A differentiates notches and holes. Notches are in the top edge between 0.07 and 0.25 of span and max 0.125 depth; drilled holes are on the neutral axis between 0.25 and 0.4 of span and max 0.25 depth."
          },
          {
            number: 39,
            prompt: "Where cables pass through a fire-resisting wall or floor, the Building Regulations concern most directly raised is:",
            options: {
            ...
            answer: "A",
            explanation: "Part B requires the fire resistance of compartment walls and floors to be maintained. Cable penetrations need suitable fire-stopping so the electrical work does not create a route for smoke or flame."
          },
          {
            number: 40,
            prompt: "A new circuit is installed from a dwelling consumer unit to supply fixed garden lighting. Under Part P in England it is:",
            options: {
            ...
            answer: "B",
            explanation: "Part P applies to fixed electrical installations in gardens or land associated with a dwelling where supplied from the dwelling. Any new circuit is notifiable, regardless of whether it runs indoors or outdoors."
          }
        ]
      },
      {
        id: "section-5-merged-regulation-safety",
        title: "Section 5 — Merged Regulation & Safety Questions",
        questions: [
          {
            number: 41,
          ...
          },
          {
            ...
            options: {
              ...
              B: "6 litres per second",
              C: "15 litres per second",
          ...
          {
            number: 48,
            prompt: "Which Act places a general duty on employers to ensure, so far as is reasonably practicable, the health, safety and welfare at work of all employees?",
            options: {
            ...
            answer: "B",
            explanation: "Health and Safety at Work etc. Act 1974. The HSWA is the primary enabling statute; the other three options are regulations made under it. Section 2 places the general duty on employers; Section 7 places a duty on employees to take reasonable care."
          },
          {
            number: 49,
            prompt: "The HSE guideline maximum weight an adult male should lift alone from waist height, close to the body, is approximately:",
            options: {
              A: "5 kg",
              B: "16 kg",
              C: "25 kg",
            ...
            answer: "C",
            explanation: "25 kg. HSE guideline weights for lifting close to the body at waist height: 25 kg for men, 16 kg for women. These are guideline trigger values from L23 — not absolute legal limits, but exceeding them triggers a more detailed risk assessment under the Manual Handling Operations Regulations 1992."
          },
          {
            number: 50,
            prompt: "Under RIDDOR 2013, a work-related electric shock incident must be reported if the injured person:",
            options: {
            ...
            answer: "B",
            explanation: "RIDDOR reportable injuries include death, specified injuries (fractures other than to fingers/thumbs/toes, amputations, crush injuries to the head/torso, serious burns, etc.), and the \"over-7-day\" incapacitation threshold. Hospital attendance alone is not the trigger."
          }
        ]
      }
    ],
    scoring: [
      {
        minScore: 45,
        range: "45–50",
        label: "Strong — homework standard"
      },
      {
        minScore: 35,
        range: "35–44",
        label: "Comfortable pass"
      },
      {
        minScore: 25,
        range: "25–34",
        label: "Re-read the relevant theory before re-attempting"
      },
      {
        minScore: 0,
        range: "< 25",
        label: "Re-watch the topic webinar before re-attempting"
      }
    ],
    priorities: [
  ...
  },
  {
    ...
    subtitle: "Combined topic drill + Access Training homework practice bank",
    description: "A focused exam built around Webinar 3 — 18th Edition of the Wiring Regulations. Drills the structure of BS 7671:2018 + A2:2022 + A3:2024, the key part numbers, the major tables electricians look up daily, and the headline provisions introduced or revised by the recent amendments (AFDDs, SPDs, EV charging). Now combined with 56 questions from the Access Training 18th Edition Amendment 2 homework: AFDDs, SPDs, EV charging on PME, prosumer installations, special locations, RCD types, disconnection times and the recent amendment provisions. Added merged BS 7671 scope, protection, cable-routing and special-location questions from the removed mixed-topic bank.",
    ...
    sections: [
        ...
        questions: [
          {
            ...
            answer: "C",
            explanation: "Seven numbered parts: 1 Scope/Object/Fundamental principles, 2 Definitions, 3 Assessment of general characteristics, 4 Protection for safety, 5 Selection and erection, 6 Inspection and testing, 7 Special installations or locations — plus the appendices and the index."
          },
          {
            number: 2,
            ...
            answer: "B",
            explanation: "Part 2 is the definitions register. Whenever a term is in italics in the text (e.g. \"competent person\", \"basic protection\"), Part 2 is the place to look — and a question about a defined term in BS 7671 is a Part 2 lookup, not a guess."
          },
          {
            number: 3,
          ...
          },
          {
            ...
            answer: "D",
            explanation: "Part 7 contains the special-location sections (701 bath/shower, 702 swimming pools, 711 exhibitions, 712 PV, 715 ELV lighting, 722 EV charging, etc.). Each one modifies — or supplements — the general requirements for that specific environment."
          }
        ]
      },
      {
        ...
        questions: [
          {
            ...
            answer: "B",
            explanation: "701 is the bath/shower section, with the well-known zones 0, 1 and 2 and the supplementary equipotential bonding rules in Reg 701.415.2 (waivable only when the four conditions of Reg 701.415.2 are all met). 722 is EV; 712 is PV; 704 is construction sites."
          },
          {
            number: 6,
            prompt: "Maximum permitted earth fault loop impedance (Zs) values for Type B / C / D circuit-breakers on 230 V circuits are tabulated in:",
            options: {
              A: "Table 41.1",
              B: "Table 41.3",
              C: "Table 54.8",
            ...
            answer: "B",
            explanation: "Table 41.3 gives the maximum Zs for the disconnection times of Reg 411.3.2.2/3 with circuit-breakers and RCBOs. Table 41.2 covers fuses; Table 54.8 covers main protective bonding sizing; Appendix 14 explains how the Cmin temperature correction is applied."
          },
          {
            number: 7,
            prompt: "Main protective bonding conductor cross-sectional areas (related to the line conductor at the origin) are given in:",
            options: {
              A: "Table 41.3",
              B: "Table 51",
              C: "Table 54.8",
            ...
            answer: "C",
            explanation: "Table 54.8 gives the minimum CSA of the main protective bonding conductor for TN and TT systems based on the line conductor size. Table 41.3 is Zs; Table 51 is conductor identification; OSG 7.1A covers different territory (small-installation diversity)."
          },
          {
            number: 8,
            prompt: "Recommended limits for voltage drop (3 % for lighting, 5 % for other uses) on a public LV supply appear in:",
            options: {
            ...
            answer: "A",
            explanation: "Section 525 sets the principle and Appendix 4 provides the worked detail (mV/A/m tables, correction factors, the 3 % / 5 % default limits and the 6 % / 8 % limits for installations supplied by a private LV source)."
          }
        ]
      },
      {
        ...
        questions: [
          {
            number: 9,
            prompt: "Since A2:2022, Arc Fault Detection Devices (AFDDs) to BS EN 62606 are required (\"shall be provided\") for single-phase AC final circuits supplying socket-outlets ≤ 32 A in:",
            options: {
            ...
            answer: "B",
            explanation: "Reg 421.1.7 makes AFDDs mandatory in those four categories of higher-risk premises and recommends them everywhere else. The justification is the residual fire risk from series and parallel arcing faults that an MCB or RCD won't detect."
          },
          {
            number: 10,
            prompt: "Surge Protective Devices (SPDs) are addressed in BS 7671 by:",
            options: {
              A: "Section 411",
            ...
            answer: "B",
            explanation: "Section 443 is the protection-against-overvoltages section that triggers the need for an SPD; Section 534 covers selection and erection. Since A2:2022, the assumption is that SPDs are required unless a documented risk-assessment route justifies omitting them."
          },
          {
            number: 11,
            prompt: "Electric Vehicle charging installations are dealt with in BS 7671 by:",
            options: {
              A: "Section 701",
              B: "Section 712",
              C: "Section 722",
            ...
            answer: "C",
            explanation: "Section 722 covers EV charging — RCD requirements (Type B or RDC-DD), PEN-fault detection on TN-C-S (open-PEN protection), socket-outlet selection, etc. 712 is PV; 753 is heating cables; 701 is bathrooms."
          },
          {
            number: 12,
            prompt: "Solar photovoltaic power supply systems are dealt with in BS 7671 by:",
            options: {
              A: "Section 712",
              B: "Section 722",
              C: "Section 740",
            ...
            answer: "A",
            explanation: "Section 712 covers PV installations (DC-side cabling, isolation, earthing of the array frame, AC-side connection, labelling). It works alongside the inverter manufacturer's instructions and the DNO's G98/G99 connection requirements."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        questions: [
          {
            number: 69,
            prompt: "For a final circuit protected by a 32 A Type B circuit breaker to BS EN 60898, the maximum earth fault loop impedance (Zs) for a 0.4 s disconnection time on a 230 V TN system (Table 41.3) is approximately:",
            options: {
              A: "1.09 Ω",
              B: "1.37 Ω",
              C: "1.44 Ω",
            ...
            answer: "B",
            explanation: "1.37 Ω. Table 41.3 of BS 7671 (18th Ed, incorporating the Cmin factor of 0.95). For Type B, Ia = 5 × In = 160 A. Zs = (0.95 × 230) / 160 = 1.366 Ω, rounded to 1.37 Ω. The 1.44 Ω figure is the pre-Cmin value seen in older references — always check the current tables."
          },
          {
            number: 70,
            prompt: "In a domestic bathroom, the minimum IP rating for equipment installed in Zone 1 is:",
            options: {
              A: "IPX2",
              B: "IPX4",
              C: "IPX5",
            ...
            answer: "B",
            explanation: "IPX4. Section 701 zones: Zone 0 = IPX7, Zone 1 = IPX4, Zone 2 = IPX4 (IPX5 where water jets are likely, e.g. commercial showers/public baths)."
          },
          {
            number: 71,
            ...
            answer: "B",
            explanation: "Reg 411.3.3 (socket outlets up to 32 A), Reg 411.3.3 (mobile equipment up to 32 A outdoors), and Reg 522.6.202 (cables <50 mm deep in walls/partitions). Additional protection is 30 mA RCD. \"All circuits\" (A) is a common trap — RCD protection is not universally required, only where the regulations call for it."
          },
          {
            number: 72,
            prompt: "Surge Protection Devices (SPDs) under Regulation 443 are required where the consequences caused by overvoltage could:",
            options: {
            ...
            answer: "B",
            explanation: "Reg 443.4 lists the consequences that mandate SPDs. Where none apply, Reg 443.5 allows a risk assessment — but for dwellings, the calculated risk level (CRL) almost always results in SPDs being required, so in practice new domestic installations include them."
          },
          {
            number: 73,
            prompt: "Under Regulation 421.1.7, Arc Fault Detection Devices (AFDDs) shall be fitted on final circuits supplying socket outlets in which of the following?",
            options: {
            ...
            answer: "B",
            explanation: "Reg 421.1.7 was updated in A2:2022: \"shall\" is applied to the higher-risk premises listed (HRRBs, purpose-built student accommodation, care homes, HMOs). For other premises AFDDs are \"recommended\" rather than mandatory. Know the four \"shall\" categories — this is a common exam question."
          },
          {
            number: 74,
            prompt: "The minimum copper csa of the main protective bonding conductor in a TN-C-S (PME) installation where the supply neutral is 25 mm² is:",
            options: {
              A: "6 mm²",
              B: "10 mm²",
              C: "16 mm²",
            ...
            answer: "B",
            explanation: "10 mm². BS 7671 Table 54.8 sets main bonding sizes for PME based on the supply neutral csa: neutral ≤ 35 mm² → bonding 10 mm² (Cu); 50 mm² → 16 mm²; 70–95 mm² → 25 mm²; 120 mm² → 35 mm²; ≥150 mm² → 50 mm². Note: for non-PME (TN-S/TT), the rule is half the earthing conductor, min 6 mm², max 25 mm² — different table."
          },
          {
            number: 75,
            ...
            answer: "B",
            explanation: "In TN-C-S, the DNO combines earth and neutral in their PEN conductor, and it splits at the cut-out into the installation's N and PE. Hazard: a broken PEN can put mains voltage on exposed metalwork — this is why main protective bonding is sized conservatively for PME and why caravans/EV charging have specific PME restrictions."
          },
          {
            number: 76,
            prompt: "Supplementary equipotential bonding in a location containing a bath or shower is NOT required provided that:",
            options: {
            ...
            answer: "B",
            explanation: "Reg 701.415.2 — all three conditions must be met for supplementary bonding to be omitted. RCD alone (A) isn't enough. This is heavily examined."
          },
          {
            number: 77,
            prompt: "For a TT system, the practical maximum earth electrode resistance (RA) generally recommended for stable long-term operation is:",
            options: {
              A: "5 Ω",
              B: "100 Ω",
              C: "200 Ω",
            ...
            answer: "C",
            explanation: "200 Ω. Theoretically, RA × IΔn ≤ 50 V gives 1667 Ω for a 30 mA RCD — but that value is unstable with seasonal ground moisture changes. The widely accepted practical limit for a reliable TT electrode is under 200 Ω; many contractors aim for under 100 Ω where possible. BS 7430 also recommends keeping it low and stable."
          },
          {
            number: 78,
            prompt: "For an installation supplied directly from the public LV distribution network, the maximum permitted voltage drop, from the origin to the furthest point, on a lighting final circuit is:",
            options: {
            ...
            answer: "A",
            explanation: "3%. Appendix 4 Table 4Ab: lighting 3%, other 5% (for public LV supply). If the installation is fed from a private source (own transformer), limits rise to 6% lighting / 8% other. These figures apply origin to furthest point of utilisation."
          },
          {
            number: 79,
            prompt: "Which of the following is NOT one of the standard correction/rating factors applied when selecting a cable's csa?",
            options: {
            ...
            answer: "D",
            explanation: "Cm doesn't exist. The standard factors are Ca (ambient temp), Cg (grouping), Ci (thermal insulation), Cc (applicable where protected by a BS 3036 fuse, or buried in ground — 0.725), Cs (soil thermal resistivity), Cd (cable depth for buried). The effective It = In / (Ca × Cg × Ci × Cc)."
          },
          {
            number: 80,
            prompt: "Cables concealed in a wall or partition at a depth of less than 50 mm must:",
            options: {
            ...
            answer: "A",
            explanation: "Reg 522.6.202 and 522.6.203. You have three compliance routes: (a) in safe zones AND 30 mA RCD protection; (b) mechanical protection against nails/screws; (c) earthed metallic covering with mechanical protection properties. Safe zones alone are insufficient — note the AND."
          }
        ]
      },
      {
  ...
  },
  {
    ...
    subtitle: "Combined topic drill + Access Training homework practice bank",
    description: "A focused exam built around the PAT-testing portion of Webinar 4. Covers the IET Code of Practice for In-service Inspection and Testing of Electrical Equipment (5th edition), equipment classes, the formal visual / combined inspection-and-test, pass values, intervals, and the legal driver behind the work. Combines the Access Training PAT homework practice bank with additional tricky questions on detachable leads, surge-protected equipment and Class II metalwork. Added merged appliance inspection, recordkeeping and electrical-science questions that support PAT calculations and appliance assessment.",
    format: "60 multiple-choice questions. Aim for 42+/60 (70%+) to pass; 54+/60 (90%+) for a strong result.",
    passMark: 42,
    sections: [
      {
        id: "section-1",
      ...
      },
      {
        ...
        questions: [
          {
            number: 9,
            prompt: "The legal driver requiring an employer to maintain electrical equipment in a safe condition (and which underpins in-service inspection and testing) is principally:",
            options: {
          ...
          {
            number: 12,
            prompt: "A user-check (the first tier of the IET COP three-tier regime) is best described as:",
            options: {
      ...
      },
      {
        ...
        questions: [
          ...
          {
            number: 48,
            prompt: "A Class I appliance has an IEC detachable supply lead. For a proper in-service check, the lead set should be:",
            options: {
          ...
          {
            number: 49,
            prompt: "An item of IT equipment contains surge suppression that would clamp a normal 500 V DC insulation resistance test. The appropriate approach is usually to:",
            options: {
      ...
      },
      {
        ...
        questions: [
          ...
          {
            number: 54,
            prompt: "A Class I appliance passes earth continuity but fails insulation resistance between live conductors and accessible metalwork. The next action should be:",
            options: {
          ...
          {
            number: 56,
            prompt: "A circuit has a supply of 230 V and a resistance of 23 Ω. The current flowing is:",
            options: {
              A: "0.1 A",
              B: "10 A",
              C: "23 A",
          ...
          {
            number: 57,
            prompt: "A 2.3 kW resistive heating element is connected to a 230 V supply. The current it draws is:",
            options: {
              A: "0.1 A",
              B: "5 A",
              C: "10 A",
          ...
          {
            number: 59,
            prompt: "Two 10 Ω heating elements are connected in series across a 230 V supply. The circuit current is approximately:",
            options: {
              A: "5.75 A",
              B: "11.5 A",
              C: "23 A",
          ...
          {
            number: 60,
            prompt: "A 230 V supply feeds a purely resistive load drawing 8 A. The power consumed is:",
            options: {
              A: "28.75 W",
              B: "238 W",
              C: "1.84 kW",
    ...
    sections: [
      ...
      },
      {
        ...
        questions: [
          ...
          {
            number: 6,
            prompt: "An R1 + R2 measurement is taken to:",
            options: {
            ...
            answer: "B",
            explanation: "R1+R2 is the loop measurement of the line conductor and the cpc taken at every accessory; the worst-case reading combined with Ze gives the calculated Zs at that point. This is the safest way to verify earth fault loop impedance because it doesn't rely on the supply being live and won't trip an RCD."
          },
          {
            number: 7,
            ...
            answer: "B",
            explanation: "BS 7671 Table 64 (now displayed as Table 6.4 in some printings of A2:2022) requires 500 V DC test with a 1.0 MΩ minimum for circuits up to 500 V. SELV/PELV use 250 V DC with 0.5 MΩ; circuits over 500 V use 1000 V DC with 1.0 MΩ."
          },
          {
            number: 8,
        ...
        questions: [
          {
            ...
            answer: "B",
            explanation: "Ze is the earth fault loop impedance external to the installation — i.e. the loop through the source and back via the earthing arrangement. It must be measured with the means of earthing disconnected so that parallel paths (such as gas and water bonding) don't artificially lower the reading."
          },
          {
            number: 10,
            ...
            answer: "B",
            explanation: "Both routes are accepted in BS 7671. Calculation is the safer first method because it doesn't trip RCDs and uses the dead-test data you've already gathered. Direct measurement is then used to confirm the calculated value, with the no-trip mode used on RCD-protected circuits."
          },
          {
            number: 11,
            ...
            answer: "A",
            explanation: "Memorise these acceptance criteria cold: at half rated current the device must not trip within 2 seconds; at rated current it must trip within 300 ms (general-type) and within 40 ms at five times rated. S-type (selective) RCDs allow longer times to support discrimination with downstream devices."
          },
          {
            number: 12,
            prompt: "The Schedule of Test Results that accompanies an EIC records:",
            options: {
            ...
            answer: "C",
            explanation: "The Schedule of Test Results is the factual numerical record of the verification. Without complete schedules the EIC declarations have nothing behind them; if a fault later develops, the numerical record is the evidence the duty holder uses to demonstrate that due diligence was carried out."
          }
        ]
      },
      {
        ...
        questions: [
          {
            ...
            options: {
              ...
              C: "Presence of an earthing conductor",
              D: "Obstacles"
            },
            answer: "C",
          ...
          },
          {
            ...
            options: {
              ...
              B: "Isolator",
              C: "Light switch",
              D: "Gas boiler connected to a fused spur"
            },
            answer: "D",
          ...
          },
          {
            ...
            options: {
              A: "Rated short circuit capacity (Icn)",
              B: "Service short circuit capacity (Ics)",
              C: "Range of trip values",
              D: "Maximum Zs value"
            },
            answer: "A",
          ...
          },
          {
            ...
            options: {
              A: "Kitchen",
              B: "Bathroom",
              C: "An exhibition stand",
              D: "Floor and ceiling heating system"
            },
            answer: "A",
          ...
          },
          {
            ...
            options: {
              ...
              D: "Insulation resistance test of floors"
            },
            answer: "B",
        ...
        questions: [
          {
            ...
            answer: "C",
            explanation: "Full safe isolation is the sequence in C. Proving the tester on a known source before and after is critical — if you skip the re-prove, you can't be sure your tester worked when it mattered. A multimeter alone (A) is not an approved voltage indicator (GS38); pulling a fuse with tape (B) is not secure lock-off."
          },
          {
            number: 57,
            prompt: "The primary purpose of initial verification of a new electrical installation is to:",
            options: {
            ...
            answer: "B",
            explanation: "BS 7671 Part 6. Initial verification confirms the installation complies with BS 7671 and is safe to energise and put into service. Contract conformity (A) is a separate commercial check; functional proving (C) is one element of verification but not its overall purpose."
          },
          {
            number: 58,
            prompt: "A contractor has installed a new final circuit in an existing domestic installation. The appropriate certification is:",
            options: {
            ...
            answer: "B",
            explanation: "Any new circuit — or new installation — requires an EIC accompanied by the inspection and test schedules. MEIWC is only permitted for additions or alterations to an existing circuit that do not extend to a new circuit. EICRs are issued following periodic inspection of an existing installation."
          },
          {
            number: 59,
            prompt: "A Minor Electrical Installation Works Certificate (MEIWC) may correctly be issued for:",
            options: {
            ...
            answer: "B",
            explanation: "MEIWC covers additions or alterations to an existing circuit where no new circuit is created — e.g. a spur, replacing a damaged accessory, relocating a switch. Anything involving a new circuit or a new installation requires an EIC."
          },
          {
            number: 60,
            prompt: "A pre-test visual inspection (Reg 642.3) should confirm, among other items, that:",
            options: {
            ...
            answer: "B",
            explanation: "The visual inspection is structured and wide-ranging: correct selection of equipment for the environment, correct rating and setting of protective devices, correct connection and identification of conductors, presence of fire barriers, warning notices, labelling, etc. A visual inspection is not simply \"does it look OK\" — a significant proportion of defects are caught before any test instrument is used."
          },
          {
            number: 61,
            prompt: "HSE Guidance Note GS38 requires that test probes and leads have:",
            options: {
            ...
            answer: "A",
            explanation: "GS38 is the practical standard for test probes used on live equipment. Finger barriers, a short exposed tip (≤ 4 mm, preferably ≤ 2 mm or retractable/shrouded), correctly rated insulation, and fused leads together limit the risk of shock and of creating a fault during a live test. Unsuitable probes are one of the commonest contributors to shock incidents in testing."
          },
          {
            number: 62,
            prompt: "A proving unit (or other known live source) is required:",
            options: {
            ...
            answer: "B",
            explanation: "Safe isolation: prove the tester on a known source → test at the point of work for dead → re-prove the tester. If the re-prove fails, the preceding \"dead\" confirmation is worthless. A proving unit gives a reliably safe source for this and is itself battery-limited to avoid shock risk."
          },
          {
            number: 63,
            prompt: "The standard insulation resistance test voltage for a 230/400 V LV installation is:",
            options: {
              A: "100 V AC",
              B: "250 V DC",
              C: "500 V DC",
            ...
            answer: "C",
            explanation: "Table 64 of BS 7671. LV installations in the range above 50 V up to 500 V are tested at 500 V DC, with a minimum acceptable value of 1.0 MΩ. SELV/PELV circuits are tested at 250 V DC (min 0.5 MΩ); systems above 500 V use 1000 V DC."
          },
          {
            number: 64,
            prompt: "A low-resistance ohmmeter used for continuity testing must be capable of delivering:",
            options: {
            ...
            answer: "B",
            explanation: "Set out in GN3: 200 mA to 10 A, 4–24 V AC or DC. The current must be high enough to break through oxide and surface contamination at joints so poor connections are revealed rather than masked. It is NOT the same instrument used for insulation resistance testing."
          },
          {
            number: 65,
            prompt: "An Electrical Installation Certificate (EIC) for new work requires signatures confirming responsibility for:",
            options: {
              A: "The customer only",
            ...
            answer: "B",
            explanation: "The EIC separates the three responsibilities explicitly, even when one individual discharges all three. This makes each competent person accountable for the part of the work they have signed for, and supports traceability if a fault is later investigated."
          },
          {
            number: 66,
            prompt: "The Schedule of Test Results accompanying an EIC or EICR is used to:",
            options: {
            ...
            answer: "B",
            explanation: "The Schedule of Test Results is the factual numerical record per circuit. It is paired with the Schedule of Inspections (a tick-box record of inspection items) to form the technical evidence behind the signed EIC or EICR. Without complete schedules the certificate itself is not valid."
          }
        ]
      },
      {
        ...
        questions: [
          {
            number: 67,
            prompt: "The recommended sequence of dead tests on a new installation (per GN3) is:",
            options: {
            ...
            answer: "A",
            explanation: "GN3 sequence (dead): continuity of protective conductors → continuity of ring conductors → IR → polarity (dead) → earth electrode resistance. Then energise and carry out live tests: polarity (live), Ze, Zs/PFC, RCD, functional. Order matters: don't do IR on a circuit you haven't proven the cpc continuity of first."
          },
          {
            number: 68,
            prompt: "The minimum acceptable insulation resistance value for a low-voltage (up to 500 V) final circuit tested at 500 V DC is:",
            options: {
              A: "0.5 MΩ",
              B: "1 MΩ",
              C: "2 MΩ",
            ...
            answer: "B",
            explanation: "1 MΩ. Table 64 gives the minimum IR for LV installations (up to 500 V) as 1.0 MΩ, tested at 500 V DC. Values below 2 MΩ should prompt investigation — they pass but signal deteriorating insulation."
          },
          {
            number: 69,
            ...
            answer: "A",
            explanation: "R1 + R2 is purely an end-to-end dead test of the line plus cpc resistance. It's used to calculate Zs without powering up: Zs = Ze + (R1+R2). Don't confuse with earth fault loop impedance, which is a live measurement including the supply impedance."
          },
          {
            number: 70,
            prompt: "A ring final circuit test gives: r1 = 0.41 Ω, rn = 0.41 Ω, r2 = 0.68 Ω. The expected R1+R2 reading, measured between line and cpc at any socket on the ring using the figure-of-eight test, is approximately:",
            options: {
              A: "0.27 Ω",
              B: "0.41 Ω",
              C: "0.68 Ω",
            ...
            answer: "A",
            explanation: "0.27 Ω. At any point on a correctly-wired ring, when the line and cpc ends are cross-connected at the DB (figure-of-eight), the R1+R2 measured at every socket should equal (r1 + r2) / 4 and be substantially constant around the whole ring. (0.41 + 0.68) / 4 = 1.09 / 4 = 0.2725 Ω. Significant variation between sockets indicates a break, interconnection, or spur on a spur."
          },
          {
            number: 71,
            prompt: "Why is continuity of protective conductors normally verified before insulation resistance during initial verification?",
            options: {
            ...
            answer: "A",
            explanation: "The dead-test sequence is logical, not arbitrary. CPC continuity proves the protective path is intact before IR, polarity and any later Zs calculation rely on it. An open cpc can make later test results misleading and would leave ADS unable to operate correctly."
          },
          {
            number: 72,
            prompt: "The R1 + R2 test method for continuity of the circuit protective conductor is carried out by:",
            options: {
          ...
          },
          {
            ...
            answer: "B",
            explanation: "The wander-lead R2 test uses a long lead from the MET (nulled first) to the bonded part under test. It is the usual method for main protective bonding, supplementary bonding, and any cpc where you cannot easily link to a line conductor at the origin. It gives the resistance of the protective conductor alone."
          },
          {
            number: 74,
            prompt: "The \"figure-of-eight\" (cross-connection) ring final circuit test is used to:",
            options: {
            ...
            answer: "A",
            explanation: "After end-to-end measurement of r1, rn and r2, the line end of one leg is cross-connected to the cpc end of the other (and vice versa) at the DB. At every socket on the ring, R1+R2 should then equal (r1 + r2) / 4 with only small variations. A significant variation indicates a break, an interconnection, or a spur fed from a spur."
          },
          {
            number: 75,
            prompt: "A lighting circuit contains electronic dimmers that cannot be disconnected without damaging the finish. Before applying a 500 V DC insulation resistance test, the inspector should:",
            options: {
            ...
            answer: "B",
            explanation: "Voltage-sensitive equipment can be damaged by a 500 V DC IR test and can also distort the result. Linking L and N together and testing to earth avoids applying the test voltage across electronic components; where that still is not suitable, disconnect or short out the equipment as instructed and record any limitation."
          },
          {
            number: 76,
            prompt: "When carrying out an insulation resistance test between live conductors and earth on a final circuit, the accepted practice is to:",
            options: {
            ...
            answer: "B",
            explanation: "Linking L and N and testing to earth gives one figure covering both live conductors, and ensures items downstream of single-pole switches are included. 500 V DC will damage SPDs and many electronic devices; lamps and dimmers also typically read low and mask the cable IR. Disconnecting and retesting section by section is also how many IR faults are localised."
          },
          {
            number: 77,
            prompt: "A dead polarity check on a final circuit confirms that:",
            options: {
            ...
            answer: "A",
            explanation: "Polarity has two strands: (i) single-pole devices must only interrupt the line conductor, and (ii) accessories must be wired with L, N and cpc on the correct terminals. Polarity is confirmed both dead (as a continuity-style test) and live (with a voltage indicator) — both are required."
          }
        ]
      },
      {
        ...
        questions: [
          {
            number: 78,
            prompt: "When testing a general-purpose 30 mA RCD (BS EN 61008/61009) at 1 × IΔn, the maximum permitted disconnection time is:",
            options: {
              A: "40 ms",
              B: "200 ms",
              C: "300 ms",
            ...
            answer: "C",
            explanation: "300 ms. For general (non-S-type) RCDs at 1 × IΔn the maximum trip time is 300 ms. At 5 × IΔn it's 40 ms. S-type (time-delayed) RCDs have different permitted ranges (130–500 ms at IΔn). The 40 ms value (A) is the trap — that's the 5× test, not the 1× test."
          },
          {
            number: 79,
            prompt: "On a circuit protected by a 30 mA RCD, the most appropriate way to obtain a reliable Zs value without tripping the RCD is:",
            options: {
            ...
            answer: "B",
            explanation: "Modern MFTs include a no-trip / low-current Zs function that uses a small current pulse so the RCD doesn't operate. Alternatively, measure Ze at the origin and R1+R2 on the circuit and sum them (adjusting R1+R2 for temperature if needed). Never fit temporary links to bypass safety devices (A) — that's a dangerous and historic practice."
          },
          {
            number: 80,
            prompt: "A newly installed radial socket circuit passes continuity but fails insulation resistance between line and earth, reading 0.2 MΩ. The most likely cause is:",
            options: {
          ...
          },
          {
            ...
            answer: "C",
            explanation: "Record the higher of the two values so every protective device is demonstrated to have a breaking capacity at least equal to the worst-case fault level. On a typical TN-C-S domestic supply in the UK this is commonly in the 1–16 kA range, depending on proximity to the substation."
          },
          {
            number: 84,
            prompt: "When testing a general-purpose 30 mA RCD at 0.5 × IΔn, the expected result is:",
            options: {
            ...
            answer: "A",
            explanation: "At half rated residual current the device must not trip within 2 seconds. This proves the RCD is not oversensitive. The 300 ms value applies at 1×IΔn; the 40 ms value applies at 5×IΔn."
          },
          {
            number: 85,
            prompt: "When the same 30 mA RCD is tested at 5 × IΔn (150 mA), the maximum permitted disconnection time is:",
            options: {
              A: "40 ms",
              B: "150 ms",
              C: "300 ms",
            ...
            answer: "A",
            explanation: "40 ms at 5 × IΔn is the high-current test that underpins the use of 30 mA RCDs as additional protection against direct contact — the fault must be cleared before ventricular fibrillation risk becomes dangerous. A common trap in exams is to swap the 40 ms and 300 ms figures between the 5× and 1× tests."
          },
          {
            number: 86,
            prompt: "An Arc Fault Detection Device (AFDD) is functionally tested in service by:",
            options: {
          ...
          },
          {
            ...
            answer: "A",
            explanation: "0.5 MΩ is below the 1.0 MΩ minimum — a fail. Likely causes: pinched or nicked cable at a back box, moisture ingress, or a failing accessory/load left in circuit (dimmer, SPD, lamp). Localise by splitting the circuit progressively and retesting each section."
          },
          {
            number: 88,
            prompt: "A measured Zs on a 32 A Type B final circuit is 1.55 Ω. The maximum Zs from Table 41.3 (230 V, 0.4 s disconnection) is 1.37 Ω. The correct action is:",
            options: {
            ...
            answer: "B",
            explanation: "Measured Zs exceeds the tabulated maximum — the overcurrent device alone will not clear a line-to-earth fault within the required 0.4 s. Root causes include an overly long cable run, undersized cpc, high Ze, or a loose connection. Compliant fixes: shorten the run, increase cpc csa, re-terminate, or provide ADS by 30 mA RCD (which is why most final circuits are now RCD-protected). Upsizing the OCPD (C) defeats overload protection and is wrong."
          },
          {
            number: 89,
            prompt: "During functional testing, a 30 mA RCD trips at 1 × IΔn in 340 ms. The correct action is:",
            options: {
            ...
            answer: "B",
            explanation: "340 ms exceeds the 300 ms limit at 1 × IΔn — the device has failed and no longer provides the additional protection claimed. Replace and retest at 0.5×, 1× and 5×IΔn, and record all three results on the schedule. Never uprate the IΔn or disable a test facility as a way to \"pass\" a failing RCD."
          },
          {
            number: 90,
            prompt: "After energising a new lighting circuit, a live polarity check shows the switch interrupts the neutral instead of the line conductor. The correct response is to:",
            options: {
            ...
            answer: "B",
            explanation: "A single-pole switch in the neutral leaves the lampholder live when it appears switched off. That is a polarity fault, not a paperwork issue. The circuit must be isolated, corrected and retested before certification."
          }
        ]
      },
      {
    ...
    sections: [
        ...
        questions: [
          {
            ...
            answer: "D",
            explanation: "10 years is the IET-recommended maximum for owner-occupied domestic, with a fresh inspection at change of occupancy. The figure is in Table 3.2 of GN3. Privately rented dwellings in England are mandated to 5 years by separate legislation (the ESS PRS Regulations 2020)."
          },
          {
            number: 2,
            ...
            answer: "C",
            explanation: "The 2020 Regulations set a 5-year maximum, with a fresh EICR at change of tenancy if that falls sooner. The landlord must supply the report to the tenant within 28 days of inspection and to a new tenant before they move in."
          },
          {
            number: 3,
            prompt: "Typical IET-recommended maximum interval for a commercial premises:",
            options: {
              A: "1 year",
              B: "3 years",
            ...
            answer: "C",
            explanation: "GN3 typically gives 5 years for commercial premises (offices, shops, restaurants). Industrial premises are typically 3 years. Specific high-risk environments (petrol stations, cinemas, swimming pools, leisure complexes) are 1 year."
          },
          {
            number: 4,
            ...
            answer: "A",
            explanation: "1 year — water and a continuous public footfall combine to create one of the highest-risk LV environments. Petrol filling stations, fish farms, marinas, leisure complexes and theatres also fall into the 1-year band."
          }
        ]
      },
      {
        ...
        questions: [
          {
            number: 5,
            prompt: "Sampling during a periodic inspection (i.e. testing only a proportion of similar circuits) is:",
            options: {
            ...
            answer: "B",
            explanation: "Sampling is the practical reality on large installations — but it is conditional. The extent (what is included) and limitations (what is excluded, and why) are recorded on the EICR, and the duty holder accepts that anything outside the sample has not been verified."
          },
          {
            number: 6,
            ...
            answer: "B",
            explanation: "A defect in the sample raises the probability that similar defects exist in the unsampled population, so the sample size must increase. Once the failure rate is significant, testing becomes 100 %. This is fundamental to GN3's sampling logic — sampling is risk-based, not a fixed percentage."
          },
          {
            number: 7,
          ...
          },
          {
            ...
            answer: "C",
            explanation: "GN3's principle is dead-test by default; live test only where dead testing isn't reasonably practicable. Live testing introduces shock risk to the inspector and arc-flash risk to the equipment, so the case for it must be specific and documented — not a workflow convenience."
          }
        ]
      },
      {
        ...
        questions: [
          {
            ...
            answer: "C",
            explanation: "EAWR Reg 4(2) requires that systems be maintained so as to prevent danger; HSWA places the general duty on the employer. Periodic inspection and testing is the recognised means of demonstrating that the duty has been discharged. Part P only applies to dwellings, and only to notifiable work."
          },
          {
            number: 10,
            ...
            answer: "B",
            explanation: "The 2020 Regulations made periodic inspection a specific statutory duty on landlords in England (5-yearly max, EICR copy to tenant within 28 days, action on C1/C2/FI within 28 days or sooner if specified). Comparable but separate regimes exist in Scotland and Wales."
          },
          {
            number: 11,
            ...
            answer: "C",
            explanation: "PIT is a condition assessment at a moment in time. The interval is risk-based precisely because faults can develop between inspections — and the duty holder remains responsible for in-service safety throughout, not only at inspection time."
          },
          {
            number: 12,
            ...
            answer: "C",
            explanation: "The EICR is the report on existing work; the EIC and MEIWC are certificates issued for new work and minor additions/alterations respectively. The EICR is supported by the Schedule of Inspections (what was looked at) and the Schedule of Test Results (what was measured)."
          }
        ]
      },
      {
        ...
        questions: [
          ...
          {
            number: 36,
            prompt: "A low insulation resistance reading is found, but the circuit cannot be isolated further during the visit because it supplies critical equipment. The most appropriate EICR observation is:",
            options: {
            ...
            answer: "B",
            explanation: "A suspicious low IR value that cannot be diagnosed during the visit is exactly when FI is used. A limitation records why the inspector could not go further; it does not make the concern disappear. FI makes the report Unsatisfactory until resolved."
          },
          {
            number: 37,
            ...
            answer: "B",
            explanation: "The EICR records the condition at the time of inspection. Any C1, C2 or FI makes the result Unsatisfactory. Later remedial work needs written confirmation or a follow-up certificate/report; it does not alter the original finding."
          },
          {
            number: 38,
            prompt: "During a sampled inspection, two of ten sampled lighting points show the same missing cpc sleeving and loose termination issue. The inspector should normally:",
            options: {
            ...
            answer: "B",
            explanation: "Sampling is conditional on the sample being representative. Repeated defects in the sample increase the likelihood that the unsampled population has the same defect, so the sample must expand and may become 100% for that group."
          },
          {
            number: 39,
            prompt: "Which item should not normally be treated as a sampling item during periodic inspection?",
            options: {
            ...
            answer: "C",
            explanation: "The origin, main switchgear and main earthing/bonding arrangements are central to the whole installation and should be inspected directly. Sampling is for repeated distributed items, not the single point on which every protective measure depends."
          },
          {
            number: 40,
      ...
      },
      {
        ...
        questions: [
          ...
          {
            number: 46,
            prompt: "A 32 A Type B final circuit has a measured Zs of 1.10 Ω. The current BS 7671 tabulated maximum is 1.37 Ω. Using the usual 80% measured-value rule of thumb, the result is:",
            options: {
            ...
            answer: "B",
            explanation: "The GN3 rule of thumb compares measured cold Zs with 80% of the tabulated value to allow for conductor heating. 1.37 × 0.8 = 1.096 Ω, so a 1.10 Ω reading is effectively on or just above the limit and should not be waved through without checking the exact table/device data and conditions."
          },
          {
            number: 47,
          ...
          },
          {
            ...
            answer: "C",
            explanation: "Copper has a positive temperature coefficient — resistance rises with temperature. This is why the IR test is taken cold and why measured R1+R2 must be corrected up to operating temperature before being used in a Zs calculation (the Cmin / temperature factor)."
          },
          {
            number: 49,
            prompt: "Two copper conductors have the same length, but one has a cross-sectional area of 1.25 mm² and the other is 2.5 mm². The resistance of the 1.25 mm² conductor will be:",
            options: {
            ...
            answer: "C",
            explanation: "R = ρL/A, so for the same material and length, resistance is inversely proportional to CSA. Halving the CSA from 2.5 mm² to 1.25 mm² doubles the resistance. This is the same relationship behind voltage drop and R1+R2 values."
          },
          {
            number: 50,
            ...
            answer: "A",
            explanation: "The ring's parallel paths share the load, allowing 2.5 mm² cable with 32 A protection (Appendix 15). \"Redundancy\" (B) is actually undesirable — a break in the ring creates an undetected radial that can be overloaded, which is why the continuity (r1/rn/r2) tests exist."
          }
        ]
      }
    ],
    ...
    sections: [
        ...
        questions: [
          {
            ...
            answer: "B",
            explanation: "Electrical Installation Condition Report — the standard BS 7671 model form for reporting on the condition of an existing installation. The inspector uses current safety expectations and coding guidance, but does not automatically require every older installation to be upgraded just because a later edition has introduced improvements."
          },
          {
            number: 2,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            answer: "B",
            explanation: "FI is used when the scope of the inspection didn't permit a definitive call but the symptom suggests a possible defect requiring deeper investigation. Like C1 and C2, the presence of an FI renders the overall report Unsatisfactory — because the installation's condition is genuinely unknown at that point."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        questions: [
          {
            number: 13,
            prompt: "An Electrical Installation Condition Report (EICR) is:",
            options: {
            ...
            answer: "B",
            explanation: "The EICR documents the condition of an existing installation at the time of the periodic inspection. Observations are coded C1 (danger present), C2 (potentially dangerous), C3 (improvement recommended) or FI (further investigation). The presence of any C1, C2 or FI makes the overall outcome Unsatisfactory."
          },
          {
            number: 14,
            prompt: "An EICR observation coded C1 means:",
            options: {
              A: "Improvement recommended",
              B: "Danger present — risk of injury; immediate remedial action required",
              C: "Potentially dangerous — urgent remedial action required",
            ...
            answer: "B",
            explanation: "C1 is the most serious code — danger is present now (e.g. exposed live parts, damaged insulation with accessible copper). The inspector should make safe before leaving the site (often by isolation) and inform the duty holder immediately. Any C1 automatically renders the overall EICR result Unsatisfactory."
          },
          {
            number: 15,
            prompt: "An EICR observation coded C2 means:",
            options: {
              A: "Danger is present",
              B: "Potentially dangerous — urgent remedial action required",
          ...
          },
          {
            ...
            answer: "B",
            explanation: "C3 means improvement recommended. It should be recorded and explained, but it does not by itself make the report Unsatisfactory. C1, C2 and FI are the codes that drive an Unsatisfactory outcome."
          },
          {
            number: 17,
            prompt: "An unexplained insulation resistance reading below the permitted minimum is found, but the inspector cannot safely access the concealed joint boxes during the visit. The most appropriate code is:",
            options: {
              A: "C3",
              B: "FI",
              C: "No code",
            ...
            answer: "B",
            explanation: "FI is used where the inspector has evidence of a possible dangerous condition but cannot fully determine its cause or extent during the inspection. It requires further investigation without delay and renders the report Unsatisfactory."
          },
          {
            number: 18,
            prompt: "A missing circuit identification label on a consumer unit, with all circuits otherwise safe and traceable during the inspection, would most commonly be coded:",
            options: {
              A: "C1",
              B: "C2",
              C: "C3",
            ...
            answer: "C",
            explanation: "Poor or missing identification is normally an improvement recommendation where it does not create immediate danger. It still matters because future isolation, maintenance and emergency work rely on clear circuit identification."
          },
          {
            number: 19,
            prompt: "A C1 observation is found and the inspector isolates the affected circuit before leaving. The report should:",
            options: {
            ...
            answer: "B",
            explanation: "Making safe is the immediate duty, but the original dangerous condition still existed at the inspection and must be recorded. The report should say what was found, what was isolated or repaired, and how the duty holder was notified."
          },
          {
            number: 20,
            prompt: "For a privately rented dwelling in England, remedial work following an Unsatisfactory EICR must normally be completed:",
            options: {
            ...
            answer: "B",
            explanation: "The ESS PRS Regulations require remedial work or further investigative work within 28 days of the inspection, or within any shorter period specified in the report. Written confirmation then needs to be supplied as required by the Regulations."
          }
        ]
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            options: {
              A: "Only be switched if used outside",
              B: "Be switched or unswitched",
              C: "Always be switched",
          ...
          },
          {
            ...
            answer: "B",
            explanation: "Main protective bonding conductors connect extraneous-conductive-parts such as metallic gas or water services to the MET. The earthing conductor connects the MET to the means of earthing; the CPC connects exposed-conductive-parts of individual circuits back to the installation earth."
          },
          {
            number: 26,
            prompt: "A multi-function tester is checked before use. Which item is specifically a GS38 live-testing safety concern?",
            options: {
            ...
            answer: "B",
            explanation: "GS38 is about safe test probes and leads: short exposed tips, finger barriers, suitable insulation and fused/current-limited leads where appropriate. Long bare probe tips can bridge terminals and create a fault or shock risk."
          },
          {
            number: 27,
            prompt: "A 13 A current passes through a conductor of resistance 0.5 Ω. The power dissipated as heat in the conductor is:",
            options: {
              A: "6.5 W",
              B: "26 W",
              C: "84.5 W",
            ...
            answer: "C",
            explanation: "P = I² × R = 13² × 0.5 = 169 × 0.5 = 84.5 W. This is the I²R loss that drives cable heating — and why a loose termination on an otherwise-correct circuit can still get hot enough to char an accessory."
          },
          {
            number: 28,
            ...
            answer: "B",
            explanation: "230 V at 50 Hz nominal (harmonised across Europe in 1995, with a tolerance of +10 % / −6 %). 240 V is the legacy figure, 110 V centre-tapped is the UK construction-site standard, and 400 V is the line-to-line voltage on a three-phase supply."
          },
          {
            number: 29,
            ...
            answer: "C",
            explanation: "Vpeak = Vrms × √2 = 230 × 1.414 ≈ 325 V. RMS is the equivalent DC value that produces the same heating effect; peak matters when you're sizing insulation, selecting SPDs, or interpreting an oscilloscope trace."
          },
          {
            number: 30,
            ...
            answer: "B",
            explanation: "For n equal resistors in parallel, RT = R / n = 6 / 3 = 2 Ω. In series the same three would total 18 Ω. The parallel-paths idea is exactly what halves the loop resistance of a ring final circuit compared with a radial of the same CSA."
          }
        ]
      }
    ],
    scoring: [
      {
        minScore: 27,
        range: "27–30",
        label: "Strong — confident with EICR coding"
      },
      {
        minScore: 23,
        range: "23–26",
      ...
      },
      {
        minScore: 18,
        range: "18–22",
        label: "Re-read the C1/C2/C3/FI definitions and Best-Practice Guide 4 from Electrical Safety First"
      },
      {
        minScore: 0,
        range: "< 18",
        label: "Re-watch the condition reporting webinar"
      }
    ],
    priorities: [
  ...
  },
  {
    ...
    description: "Representative of the knowledge and written-response element of the AM2 / AM2E end-point assessment for the Installation & Maintenance Electrician apprenticeship standard, delivered by NET. The practical assessment is hands-on installation, inspection, testing, fault-finding and commissioning — this exam drills the underpinning knowledge those practical tasks rely on. Built against BS 7671 (18th Edition, A2:2022 + A3:2024), HSG85, GS38 and Guidance Note 3. Added merged load calculation, three-phase, transformer, diversity and safe-live-working questions that fit the AM2 written/practical knowledge mix.",
    format: "40 multiple-choice questions. Aim for 28+/40 (70%+) in about 75 minutes — the AM2 practical is a separate test of skill, but consistent knowledge of these topics underpins every task.",
    passMark: 28,
    sections: [
      {
        id: "section-1",
        ...
        questions: [
          {
            ...
            answer: "B",
            explanation: "HSG85 is HSE's practical guidance on safe electrical working — criteria for dead vs live work, competence, risk control, and procedures. BS 7671 is the installation standard, GN3 covers inspection & testing, and PUWER covers work equipment generally. On AM2, your safe-isolation approach is judged against HSG85."
          },
          {
            number: 2,
            prompt: "The full safe isolation sequence you must demonstrate on AM2 is:",
            options: {
            ...
            answer: "B",
            explanation: "Identification and permission matter on shared or commercial premises. Lock-off secures the isolation. Proving the tester on a known source BEFORE and AFTER the dead test is the part candidates most often miss — it's what makes the 'dead' reading trustworthy."
          },
          {
            number: 3,
          ...
          },
          {
            ...
            answer: "B",
            explanation: "Regulation 14 of EAWR 1989 and HSG85 require isolation to be carried out with permission where others may be affected. On larger sites a permit-to-work formalises this. Isolating without permission is a common AM2 failure point — the assessor is watching for it."
          },
          {
            number: 5,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            answer: "B",
            explanation: "A single-pole switch must only interrupt the line conductor (Reg 132.14 / 537). If it interrupts the neutral instead, the accessory remains live with the switch off — very dangerous during lamp changes. Polarity must be confirmed both dead (during dead tests) and live (after energising)."
          },
          {
            number: 19,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            answer: "A",
            explanation: "A near-zero L-N IR with loads removed is a direct short on the fixed wiring. Common causes: nail/screw penetration (especially outside safe zones), pinched cable at a back-box or under a flooring pin, or a shorted accessory. Localise by section — disconnect at the DB and each accessory in turn, retesting IR."
          },
          {
            number: 23,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            answer: "A",
            explanation: "General-type 30 mA RCD limits: 0.5×IΔn must NOT trip within 2 s, 1×IΔn must trip in ≤ 300 ms, 5×IΔn must trip in ≤ 40 ms. All three must be recorded. S-type (time-delayed) RCDs have different figures — used for selectivity with a downstream 30 mA RCD."
          },
          {
            number: 28,
            ...
            answer: "B",
            explanation: "Rotation at the DB must match the convention so every three-phase load (motors, HVAC plant, lifts, fire pumps) starts the correct way. Fixing rotation at a single motor only masks the board-level cross. Always correct at the root cause and re-verify."
          },
          {
            number: 29,
      ...
      },
      {
        ...
        questions: [
          ...
          {
            number: 32,
            prompt: "Under the Electricity at Work Regulations 1989, live working may only be undertaken if:",
            options: {
            ...
            answer: "B",
            explanation: "EAWR 1989, Regulation 14 sets three conjunctive tests: (i) unreasonable for it to be dead, (ii) reasonable for work to be done live, (iii) suitable precautions taken. All three must be satisfied — gloves or a voltage threshold alone don't authorise live work."
          },
          {
            number: 33,
            prompt: "Using the On-Site Guide diversity method, the assumed maximum demand of a household cooker control unit incorporating a 13 A socket, supplied by a 30 A circuit, is:",
            options: {
            ...
            answer: "B",
            explanation: "On-Site Guide diversity for household cookers: first 10 A of rated current at 100% + 30% of the remainder + 5 A if a socket is included in the control unit. Example for a 30 A cooker with socket: 10 + (0.30 × 20) + 5 = 10 + 6 + 5 = 21 A assumed demand."
          },
          {
            number: 34,
            prompt: "A cooker circuit has a 45 A rated load and the control unit includes a 13 A socket. Using the On-Site Guide diversity rule, the assumed demand is:",
            options: {
              A: "13.5 A",
              B: "20.5 A",
              C: "25.5 A",
            ...
            answer: "C",
            explanation: "Cooker diversity = first 10 A + 30% of the remaining load + 5 A for an integral socket. 10 + (0.30 × 35) + 5 = 25.5 A. The trick is to apply the 30% only to the current above the first 10 A."
          },
          {
            number: 35,
            ...
            answer: "C",
            explanation: "400 V (line-to-line). The relationship is VL = √3 × VP, so 230 × 1.732 ≈ 400 V. Line-to-neutral is 230 V; line-to-line is 400 V. Confusing the two is the most common slip in three-phase calculations."
          },
          {
            number: 36,
            ...
            answer: "C",
            explanation: "120°. Three phases are equally spaced around the cycle: L1 at 0°, L2 at 120°, L3 at 240°. This is what allows balanced loads to draw zero net neutral current and lets three-phase motors start without an auxiliary winding."
          },
          {
            number: 37,
            prompt: "A 2 kW resistive load is connected to a 230 V supply. The current drawn is approximately:",
            options: {
              A: "4.6 A",
              B: "8.7 A",
              C: "11.5 A",
            ...
            answer: "B",
            explanation: "8.7 A. P = V × I, so I = P/V = 2000/230 = 8.696 A ≈ 8.7 A. For a purely resistive load, power factor = 1, so this is also the apparent current."
          },
          {
            number: 38,
            prompt: "A balanced three-phase load draws 30 A per line at 400 V (line-to-line) with a power factor of 0.85 lagging. Total real power consumed is approximately:",
            options: {
              A: "8.8 kW",
              B: "17.7 kW",
              C: "20.8 kW",
            ...
            answer: "B",
            explanation: "17.7 kW. P = √3 × VL × IL × cos φ = 1.732 × 400 × 30 × 0.85 = 17,666 W ≈ 17.7 kW. A common slip is to forget the √3 or to use phase voltage (230 V) instead of line voltage — always check which voltage you've been given."
          },
          {
            number: 39,
            prompt: "A transformer has 1000 primary turns and 200 secondary turns. With a primary voltage of 230 V, the open-circuit secondary voltage is:",
            options: {
              A: "11.5 V",
              B: "46 V",
              C: "115 V",
            ...
            answer: "B",
            explanation: "46 V. For an ideal transformer: VS/VP = NS/NP → VS = 230 × (200/1000) = 46 V. This is a step-down transformer (turns ratio 5:1)."
          },
          {
            number: 40,
            prompt: "A balanced three-phase load draws equal current in each line. The current in the neutral conductor is:",
            options: {
            ...
            answer: "C",
            explanation: "In a balanced three-phase system the three line currents are 120° apart and cancel vectorially in the neutral, so neutral current is approximately zero. Unbalanced single-phase loads and harmonics are what make neutral current appear in practice."
          }
        ]
      }
    ],
    scoring: [
      {
        minScore: 36,
        range: "36–40",
        label: "Strong — AM2-ready on knowledge"
      },
      {
        minScore: 32,
        range: "32–35",
        label: "Comfortable pass, polish weak topics"
      },
      {
        minScore: 28,
        range: "28–31",
        label: "Borderline — review gaps before the EPA"
      },
      {
        minScore: 0,
        range: "< 28",
        label: "More revision needed before sitting AM2"
      }
    ],
    priorities: [

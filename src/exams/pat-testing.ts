...
import { electricianTrainingPatMockQuestions, electricianTrainingPatSourceSection } from "./electrician-training-source";

function makeElectricianTrainingPatVariant(sectionIndex: number): ExamQuestion[] {
  const chunkSize = 10;
  return electricianTrainingPatMockQuestions
    .slice(sectionIndex * chunkSize, sectionIndex * chunkSize + chunkSize)
    .map((question, questionIndex) => ({
      number: sectionIndex * chunkSize + questionIndex + 1,
      ...question
    }));
}
...
export const patTestingExam: Exam = {
  id: "pat-testing",
  title: "PAT Testing",
  subtitle: "Combined topic drill + copied ElectricianTraining PAT mock",
  description:
    "A focused exam built around the PAT-testing portion of Webinar 4 and the City & Guilds 2377-style EET/PAT assessment. Covers the IET Code of Practice for In-service Inspection and Testing of Electrical Equipment (5th edition), equipment classes, the formal visual / combined inspection-and-test, pass values, intervals, and the legal driver behind the work. Keeps four broad revision variants and adds the copied 50-question ElectricianTraining PAT mock as the fifth variation. Includes tricky questions on detachable leads, surge-protected equipment, Class II metalwork, appliance inspection, recordkeeping, and electrical-science calculations that support PAT assessment.",
  format:
    "Each attempt = 50 multiple-choice questions. Pass at 80%+. The first four attempts use topic drills; the fifth serves the copied PAT mock.",
  passPercent: 0.8,
  sections: [
    {
      id: "section-1",
      ...
      variants: [
        ...
        {
          id: "v5",
          questions: makeElectricianTrainingPatVariant(0)
        }
      ]
    },
    {
      ...
      variants: [
        ...
        {
          id: "v5",
          questions: makeElectricianTrainingPatVariant(1)
        }
      ]
    },
    {
      ...
      variants: [
        ...
        {
          id: "v5",
          questions: makeElectricianTrainingPatVariant(2)
        }
      ]
    },
    {
      ...
      variants: [
        ...
        {
          id: "v5",
          questions: makeElectricianTrainingPatVariant(3)
        }
      ]
    },
    {
      ...
      variants: [
        ...
        {
          id: "v5",
          questions: makeElectricianTrainingPatVariant(4)
        }
      ]
    },
    electricianTrainingPatSourceSection
  ],
  scoring: [
    { threshold: 0.9, label: "Strong — exam-ready on classification, tests, and the legal driver" },
    { threshold: 0.8, label: "Pass — solid command of Class definitions, test methods, and records" },
    { threshold: 0.6, label: "Near miss — revise thresholds, Class selection, and recordkeeping" },
  ...
  priorities: [
    ...
    "Full mock focus: risk assessment, Class selection, surge-filter test methods, calibration traceability, labels and recordkeeping."
  ]
};
